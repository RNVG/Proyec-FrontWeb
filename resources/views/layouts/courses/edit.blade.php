...
<head>
    ...
    <title>Academy | Editar Curso</title>
    ...
    <meta name="title" content="Academy | Editar Curso" />
    <meta name="author" content="ColorlibHQ" />
    <meta name="description" content="Formulario para editar cursos en el sistema Academy." />
    <meta name="keywords" content="academy, cursos, editar curso, adminlte, laravel, blade" />
                    ...
                    <div class="row g-4">
                        <div class="col-md-12">
                            <div class="card card-info card-outline mb-4">
                                ...
                                <form action="{{ route('courses.update', $course['id']) }}" method="POST" class="needs-validation"
                                    novalidate>
                                    @csrf
                                    @method('PUT')
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="number" name="capacity" id="capacity"
                                                    ...
                                                    value="{{ old('capacity', $course['capacity']) }}" min="1" required />
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="date" name="start_date" id="start_date"
                                                    ...
                                                    value="{{ old('start_date', !empty($course['start_date']) ? \Carbon\Carbon::parse($course['start_date'])->format('Y-m-d') : '') }}"
                                                    required />
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="time" name="start_time" id="start_time"
                                                    ...
                                                    value="{{ old('start_time', !empty($course['start_time']) ? \Carbon\Carbon::parse($course['start_time'])->format('H:i') : '') }}"
                                                    required />
